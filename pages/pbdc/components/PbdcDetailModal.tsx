...
import { Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Divider, Grid, List, TextField, Typography } from "@mui/material";
...
const PdbcDetailModal : FC<ModalProps> = ({ isLoading, isOpen, pbdc, onSave, onSaveDraftDetail, onDeleteDraftDetail, onClose }) => {
        ...
        <div>
          ...
          <Dialog open={isOpen} fullWidth>
            <DialogTitle sx={{
                ...
                <Typography gutterBottom>Detail Penerimaan Barang DC</Typography>
            </DialogTitle>
            <DialogContent>
                <Box sx={{
                    height: "40%"
                    ...
                    <Grid container>
                        <Grid xs={6} sx={{
                            ...
                            <Typography variant="subtitle1" gutterBottom>List Barang</Typography>
                        </Grid>
                        <Grid xs={6} sx={{
                            paddingTop: '10px',
                            display: "grid"
                        }}>
                            <Button variant="outlined" size="small" sx={{ alignItems: "end" }} color="success" onClick={handleOpenModal}>
                                Tambah
                            </Button>
                        </Grid>
                    </Grid>
                ...
                <Box sx={{
                    ...
                    <Grid xs={12} sx={{
                        ...
                        <List sx={{ width: '100%', height: "400px", bgcolor: 'background.paper', overflow: "scroll" }}>
                            {listDetails?.map((value) => {
                                return (<>
                                        <LsiListItem 
                                            ...
                                            onDelete={() => handleDeleteDraftDetail(value.id)}/>
          ...
          <PdbcFormModal isLoading={isLoading} onClose={handleCloseModal} isOpen={openModal} onSaveDraftDetail={handleSaveDraftDetail} />
        </div>
      );
}
